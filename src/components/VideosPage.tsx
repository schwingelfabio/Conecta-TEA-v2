...
const AUTISM_VIDEOS: { [key: string]: { videoId: string, title: string, description: string, duration: string, category: string, tags?: string[] }[] } = {
  pt: [
    ...
    { videoId: 'TW2Y33Tqja8', title: 'Sobrecarga Sensorial', description: 'Como ajudar na regulação sensorial.', duration: '2:00', category: 'Dicas Rápidas' },
    { videoId: 'tNuM5SI_UxE', title: 'Construindo Confiança', description: 'Empoderando sua criança.', duration: '1:40', category: 'Apoio Emocional' },
    { videoId: 'bQ9HwhO9voc', title: 'Crises em Público', description: 'Mantenha a calma em locais públicos.', duration: '2:30', category: 'Cenários Reais' },
    { videoId: 'nVtBctQhXwI', title: 'Contato Visual', description: 'Pequenas dicas para conexão.', duration: '1:00', category: 'Dicas Rápidas' },
    { videoId: 'oM5pUsG6p0s', title: 'Rotina de Sono', description: 'Noites melhores para todos.', duration: '2:20', category: 'Dicas' },
    { videoId: 'A3855OOeM_4', title: 'Celebrando Pequenas Vitórias', description: 'Por que cada conquista importa.', duration: '1:15', category: 'Apoio Emocional' },
    { videoId: 'AKFKCj9hM_Q', title: 'Apoio aos Irmãos', description: 'Ajudando irmãos neurotípicos.', duration: '2:00', category: 'Cenários Reais' },
    { videoId: 'lKkbO2ABKL4', title: 'Rotinas Visuais', description: 'Como usar apoios visuais.', duration: '1:50', category: 'Dicas Rápidas' },
    { videoId: '9bZkp7q19f0', title: 'Entendendo Estereotipias (Stims)', description: 'Por que eles fazem isso?', duration: '2:10', category: 'Dicas' },
    { videoId: '3JZ_D3ELwOQ', title: 'Autocuidado para Pais', description: 'Não esqueça de você.', duration: '1:30', category: 'Apoio Emocional' },
    { videoId: 'V-_O7nl0Ii0', title: 'Festas de Aniversário Inclusivas', description: 'Diversão para todos.', duration: '2:00', category: 'Cenários Reais' },
    { videoId: 'C0DPdy98e4c', title: 'Gerenciando a Ansiedade', description: 'Técnicas de acalmamento.', duration: '2:40', category: 'Dicas' },
    { videoId: 'TW2Y33Tqja8', title: 'Reforço Positivo', description: 'Como elogiar de forma eficaz.', duration: '1:50', category: 'Dicas Rápidas' },
    { videoId: 'tNuM5SI_UxE', title: 'Aplicativos de Comunicação', description: 'Ferramentas para crianças não-verbais.', duration: '2:30', category: 'Dicas' },
    { videoId: 'bQ9HwhO9voc', title: 'Lidando com Transições', description: 'Tornando as mudanças mais fáceis.', duration: '2:00', category: 'Cenários Reais' },
    { videoId: 'nVtBctQhXwI', title: 'Autismo e Puberdade', description: 'Navegando pelas mudanças.', duration: '2:50', category: 'Cenários Reais' },
    { videoId: 'oM5pUsG6p0s', title: 'Cães de Assistência', description: 'Como eles podem ajudar.', duration: '2:15', category: 'Dicas' },
    { videoId: 'A3855OOeM_4', title: 'Dicas para Viagens', description: 'Voando sem estresse.', duration: '2:30', category: 'Cenários Reais' },
  ],
  en: [
