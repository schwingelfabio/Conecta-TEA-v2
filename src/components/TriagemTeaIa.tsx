                ...
                <div className="absolute inset-0 bg-gradient-to-t from-white via-white/90 to-transparent z-10 flex flex-col items-center justify-end pb-8">
                  <div className="bg-slate-900 text-white p-6 rounded-3xl shadow-2xl max-w-sm text-center transform group-hover:scale-105 transition-transform">
                    ...
                    <h3 className="text-xl font-bold mb-2">
                      {(i18n.language === 'pt' ? 'Desbloquear Mapa Completo' : i18n.language === 'ja' ? 'Unlock Full Map' : 'Unlock Full Map')}
                    </h3>
                    <p className="text-sm text-slate-300 mb-4">
                      {(i18n.language === 'pt' ? 'Tenha acesso a todos os passos, chat 24h com a Sofia IA e ferramentas SOS.' : i18n.language === 'ja' ? 'Get all steps, 24/7 chat with Sofia AI and SOS tools.' : 'Get all steps, 24/7 chat with Sofia AI and SOS tools.')}
                    </p>
                    <a 
                    ...
                    <p className="text-xs text-slate-400 mt-3">
                      {(i18n.language === 'pt' ? 'Cancele quando quiser. Doações também aceitas.' : i18n.language === 'ja' ? 'Cancel anytime. Donations accepted.' : 'Cancel anytime. Donations accepted.')}
                    </p>
                  </div>
                </div>
